        ...
        extends Rule<LogicalPlan>
{
            ...
            Map<String, Expression> columnMaskExpressions)
    {
        ...
        if (columnMaskExpressions != null && !columnMaskExpressions.isEmpty()) {
            ...
            Seq<NamedExpression> newProjections = CollectionConverters
                    .ListHasAsScala(CollectionConverters
                            .SeqHasAsJava(currentProjections)
                            .asJava()
                            .stream()
                            .map(attribute -> {
            ...
            Seq<String> uRelName, String[] currentNamespace)
    {
        ...
        qualifierBuilder.addOne(getVastCatalog().name());
        for (String part : namespace) {
            qualifierBuilder.addOne(part);
        }
